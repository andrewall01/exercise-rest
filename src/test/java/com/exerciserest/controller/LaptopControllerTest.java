...
class LaptopControllerTest {
    ...
    void create() {
        ...
        /*String json =
                "{"
                        ...
                        + "'modelo': 'TOSHIBA'"
                + "}";*/
        String json = "{\"id\":0,\"marca\":\"TOSHIBA\",\"modelo\":\"TOSHIBA\"}";
   ...
   @Test
    void update() {
       ...
       String json = "{\"id\":0,\"marca\":\"TOSHIBA\",\"modelo\":\"TOSHIBA\"}";
       HttpEntity<String> request = new HttpEntity<>(json, headers);
       ResponseEntity<Laptop> post = testRestTemplate.exchange("/api/laptop", HttpMethod.POST, request, Laptop.class);
       ResponseEntity<Laptop> response = testRestTemplate.exchange("/api/laptop", HttpMethod.PUT, post, Laptop.class);
       Laptop result = response.getBody();
       assertEquals(1L, result.getId());
       assertEquals("TOSHIBA", result.getMarca());
    }
    ...
    @Test
    void delete() {
        ResponseEntity<Laptop> response = testRestTemplate.exchange("/api/laptop",HttpMethod.DELETE,null,Laptop.class);
